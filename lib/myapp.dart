...
class _dreamcanadaState extends State<dreamcanada> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: ListView(
            ...
            children: [
              ListTile(
                ...
                title: Text("Requirements", style: TextStyle(fontSize: 30.0, color: Colors.black),),
                onTap: () {},
              ),
              ListTile(
                minVerticalPadding: 20.0,
                title: Text("Top Universities", style: TextStyle(fontSize: 30.0, color: Colors.black),),
                onTap:() {},
              ),
              ListTile(
                minVerticalPadding: 20.0,
              ...
              ListTile(
                minVerticalPadding: 20.0,
                title: Text("Procedure", style: TextStyle(fontSize: 30.0, color: Colors.black),),
                onTap: () {},
              ),
              ListTile(
                minVerticalPadding: 20.0,
                title: Text("Get Help !", style: TextStyle(fontSize: 30.0, color: Colors.black),),
                onTap: () {},
              ),
            ],
          ),
      ...
      if (details.delta.dx < 0) {setState((){
        if(home<2){home=home+1;}
        else {home=0;}
      });};
      if (details.delta.dx > 0) {setState((){
        if(home>0){ home=home-1; }
        else{home=2;}
      });};
      },
              child: Container(
      ...
      floatingActionButton: FloatingActionButton(backgroundColor: Colors.teal,onPressed: () {},child: Icon(Icons.chat),),
    );
  }
  ...
  sethome() {
    ...
    return Column(
      ...
      children: [
        Center(child: Text("COURSES",style: TextStyle(
    ...
    child: Padding(
      ...
      return Column(
        mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [
          Center(child: Text("INFORMATION",style: TextStyle(
              fontWeight: FontWeight.w600, fontSize: 20.0
          ),)),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
    ...
    child: Container(
                  ...
                  height: 0.2*MediaQuery.of(context).size.height,
                  color: Colors.grey.shade100,
                  child: Center(child: Column(children: [ Icon(Icons.shopping_bag_outlined, size: 50.0,),
                    Text("Requirements")],
                    mainAxisAlignment: MainAxisAlignment.spaceAround,)),
                ), ),
              GestureDetector( onTap: (){
                ...
                child: Container(
                  ...
                  height: 0.2*MediaQuery.of(context).size.height,
                  color: Colors.grey.shade100,
                  child: Center(child: Column(children: [ Icon(Icons.account_balance_outlined, size: 50.0,),
    ...
    child: Container(
                  ...
                  height: 0.2*MediaQuery.of(context).size.height,
                  color: Colors.grey.shade100,
                  child: Center(child: Column(children: [ Icon(Icons.school_outlined, size: 50.0,),
                    Text("Scholarships")],
                    mainAxisAlignment: MainAxisAlignment.spaceAround,)),
                ), ),
    GestureDetector( onTap: (){Navigator.push(context,
    ...
    child: Container(
                  ...
                  height: 0.2*MediaQuery.of(context).size.height,
                  color: Colors.grey.shade100,
                  child: Center(child: Column(children: [ Icon(Icons.screen_rotation_alt_outlined, size: 50.0,),
                    Text("Procedure")],
                    mainAxisAlignment: MainAxisAlignment.spaceAround,)),
                ),),
            ],
    ...
    child: Padding(
      ...
      return Column(
        mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [
          Center(child: Text("GET UPDATES",style: TextStyle(
              fontWeight: FontWeight.w600, fontSize: 20.0
          ),)),
          Form(key: formKey,
              child: Column(
